...
import { B as Block, S as Static, n as BlockTitle } from "./2.BnWZeegF.js";
  ...
  return {
    ...
    p(ctx2, [dirty]) {
      ...
      16384)
        ...
        ctx2[14];
      if (dirty & /*$$scope, choices, disabled, rtl, value, gradio, root, show_label, info, label, loading_status*/
      67170703) {
