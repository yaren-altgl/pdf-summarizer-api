...
import { a as Upload } from "./Upload.DSdjghlq.js";
import { B as Block, S as Static } from "./2.BnWZeegF.js";
import { B as BlockLabel } from "./BlockLabel.BVuVU7a-.js";
import { V as Video$1 } from "./Video.CzEOFOtQ.js";
import { S as SelectSource } from "./SelectSource.CZNpaPKB.js";
import { W as Webcam } from "./ImageUploader.DXB0PRWV.js";
/* empty css                                               */
import { p as prettyBytes, a as playable } from "./Video.DWV3_nW2.js";
import { l } from "./Video.DWV3_nW2.js";
import { P as Player, V as VideoPreview } from "./VideoPreview.BljETIEL.js";
import { default as default2 } from "./Example.DlOxKqgC.js";
import { U as UploadText } from "./UploadText.DJ1wIiHF.js";
...
function create_key_block(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      if (dirty[0] & /*webcam_options, active_source*/
      258)
        player_changes.mirror = /*webcam_options*/
        ctx2[8].mirror && /*active_source*/
        ctx2[1] === "webcam";
      if (dirty[0] & /*label*/
      32)
...
function instance$1($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$props2) => {
    ...
    if ("webcam_options" in $$props2)
      $$invalidate(8, webcam_options = $$props2.webcam_options);
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      8192)
        ...
        ctx2[13];
      if (dirty[0] & /*_video, _subtitle, label, show_label, show_download_button, sources, active_source, webcam_options, include_audio, autoplay, root, loop, gradio, uploading, dragging, loading_status*/
...
function create_default_slot_1(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      if (dirty[0] & /*webcam_options*/
      524288)
        video_changes.webcam_options = /*webcam_options*/
        ctx2[19];
      if (dirty[0] & /*include_audio*/
      1048576)
...
function instance($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$props2) => {
    ...
    if ("webcam_options" in $$props2)
      $$invalidate(19, webcam_options = $$props2.webcam_options);
    if ("include_audio" in $$props2)
...
class Index extends SvelteComponent {
  ...
  set webcam_options(webcam_options) {
    this.$$set({ webcam_options });
    flush();
  }
  get include_audio() {
    return this.$$.ctx[20];
