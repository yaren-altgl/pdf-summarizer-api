...
import { M as MarkdownCode, G as css_units, H as copy, I as IconButton, J as Check, K as Copy, B as Block, S as Static } from "./2.BnWZeegF.js";
import { I as IconButtonWrapper } from "./IconButtonWrapper.CNKTJUbF.js";
import { default as default2 } from "./Example.D2zJX3DX.js";
...
function create_default_slot$1(ctx) {
  ...
  iconbutton = new IconButton({
    props: {
      ...
      label: (
        /*copied*/
        ctx[14] ? "Copied conversation" : "Copy conversation"
      )
    }
  });
  iconbutton.$on(
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      16384)
        ...
        ctx2[14] ? "Copied conversation" : "Copy conversation";
...
function create_fragment$1(ctx) {
  ...
  return {
    ...
    p(ctx2, [dirty]) {
      ...
      if (dirty & /*theme_mode*/
      8192)
        markdowncode_changes.theme_mode = /*theme_mode*/
        ctx2[13];
...
function instance$1($$self, $$props, $$invalidate) {
  ...
  function copy_feedback() {
    $$invalidate(14, copied = true);
    if (timer)
      clearTimeout(timer);
    timer = setTimeout(
      () => {
        $$invalidate(14, copied = false);
      },
      1e3
    );
  }
  $$self.$$set = ($$props2) => {
    ...
    if ("theme_mode" in $$props2)
      $$invalidate(13, theme_mode = $$props2.theme_mode);
  };
  $$self.$$.update = () => {
    if ($$self.$$.dirty & /*value*/
    4) {
  ...
  return {
    ...
    p(ctx2, [dirty]) {
      ...
      8192)
        ...
        ctx2[13];
      if (dirty & /*$$scope, loading_status, value, elem_classes, visible, rtl, latex_delimiters, sanitize_html, line_breaks, header_links, show_copy_button, gradio, theme_mode*/
      2181118) {
...
function instance($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$props2) => {
    if ("label" in $$props2)
      $$invalidate(17, label = $$props2.label);
