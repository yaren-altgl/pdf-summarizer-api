const __vite__fileDeps=["./index.BGjQ7lEF.js","./index.D1tsB_Uf.js","./index.C3QiiGlm.js","./index.BebZsvA7.js","./index.DcNjJlgG.js","./index.D9wuz_in.js","./frontmatter.Dzt8RUxO.js","./yaml.BMKOA8H-.js","./index.7ZxP2E9S.js"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
...
import { f as getWorkerProxyContext, I as IconButton, J as Check, K as Copy$1, B as Block, S as Static } from "./2.BnWZeegF.js";
...
const lang_map = {
  python: () => __vitePreload(() => import("./index.BGjQ7lEF.js"), true ? __vite__mapDeps([0,1]) : void 0, import.meta.url).then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      __vitePreload(() => import("./index.C3QiiGlm.js"), true ? __vite__mapDeps([2,3,1,4,5]) : void 0, import.meta.url),
      __vitePreload(() => import("./frontmatter.Dzt8RUxO.js"), true ? __vite__mapDeps([6,7]) : void 0, import.meta.url)
    ]);
    return md.markdown({ extensions: [frontmatter.frontmatter] });
  },
  latex: () => __vitePreload(() => import("./stex.B6LNC55o.js"), true ? [] : void 0, import.meta.url).then(
    (m) => StreamLanguage.define(m.stex)
  ),
  json: () => __vitePreload(() => import("./index.7ZxP2E9S.js"), true ? __vite__mapDeps([8,1]) : void 0, import.meta.url).then((m) => m.json()),
  html: () => __vitePreload(() => import("./index.BebZsvA7.js"), true ? __vite__mapDeps([3,1,4,5]) : void 0, import.meta.url).then((m) => m.html()),
  css: () => __vitePreload(() => import("./index.DcNjJlgG.js"), true ? __vite__mapDeps([4,1]) : void 0, import.meta.url).then((m) => m.css()),
  javascript: () => __vitePreload(() => import("./index.D9wuz_in.js"), true ? __vite__mapDeps([5,1]) : void 0, import.meta.url).then((m) => m.javascript()),
  jinja2: () => __vitePreload(() => import("./jinja2.2Vo2sGef.js"), true ? [] : void 0, import.meta.url).then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => __vitePreload(() => import("./index.D9wuz_in.js"), true ? __vite__mapDeps([5,1]) : void 0, import.meta.url).then(
