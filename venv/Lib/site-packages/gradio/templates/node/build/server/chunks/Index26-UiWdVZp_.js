...
import ImagePreview from './ImagePreview-IW5CV0HG.js';
import { B as Block, S as Static, U as UploadText, h as Empty, g as Image, d as StreamingBar, f as BlockLabel, i as IconButtonWrapper, F as FullscreenButton, j as IconButton, H as Clear, w as Image$1, a8 as SelectSource, ab as Webcam$2, a9 as Spinner, ac as Square, ad as Circle, ae as Camera, af as DropdownArrow, aa as prepare_files } from './2-Dumg1EEj.js';
import { U as Upload } from './ModifyUpload-CfMiehJn.js';
export { default as BaseExample } from './Example11-DdIXML81.js';
...
const css = {
  code: ".image-frame.svelte-11chud3 img{width:var(--size-full);height:var(--size-full);object-fit:scale-down}.upload-container.svelte-11chud3{display:flex;align-items:center;justify-content:center;height:100%;flex-shrink:1;max-height:100%}.reduced-height.svelte-11chud3{height:calc(100% - var(--size-10))}.image-container.svelte-11chud3{display:flex;height:100%;flex-direction:column;justify-content:center;align-items:center;max-height:100%}.selectable.svelte-11chud3{cursor:crosshair}",
...
const ImageUploader = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${validate_component(BlockLabel, "BlockLabel").$$render(
      ...
      {},
      {}
    )} <div data-testid="image" class="image-container svelte-11chud3"${add_attribute("this", image_container, 0)}>${validate_component(IconButtonWrapper, "IconButtonWrapper").$$render($$result, {}, {}, {
      default: () => {
      ...
      "upload-container svelte-11chud3",
      ...
      {}
    )}` : `${value !== null && !streaming ? `  <div class="${["image-frame svelte-11chud3", selectable ? "selectable" : ""].join(" ").trim()}">${validate_component(Image$1, "Image").$$render($$result, { src: value.url, alt: value.alt_text }, {}, {})}</div>` : ``}`}</div> ${sources.length > 1 || sources.includes("clipboard") ? `${validate_component(SelectSource, "SelectSource").$$render(
      $$result,
      {
        sources,
        handle_clear,
...
//# sourceMappingURL=Index26-UiWdVZp_.js.map
