...
import { B as Block, S as Static, f as BlockLabel, Q as Code$2, h as Empty, j as IconButton, z as Copy$1, D as DownloadLink, k as Download$1, i as IconButtonWrapper, V as getWorkerProxyContext } from './2-Dumg1EEj.js';
...
const lang_map = {
  python: () => import('./index32-_64V8kIa.js').then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      import('./index33-CYz97XRL.js'),
      import('./frontmatter-CZGZ-l5V.js')
    ]);
    return md.markdown({ extensions: [frontmatter.frontmatter] });
  },
  latex: () => import('./stex-CJISL_Ys.js').then(
    (m) => StreamLanguage.define(m.stex)
  ),
  json: () => import('./index37-BI2kY3nz.js').then((m) => m.json()),
  html: () => import('./index34-B8hSTwP2.js').then((m) => m.html()),
  css: () => import('./index35-BgLp1DDF.js').then((m) => m.css()),
  javascript: () => import('./index36-Ckmjph_9.js').then((m) => m.javascript()),
  jinja2: () => import('./jinja2-BxhAu_54.js').then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => import('./index36-Ckmjph_9.js').then(
...
//# sourceMappingURL=Index15-BqD76Iju.js.map
